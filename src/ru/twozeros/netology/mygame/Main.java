...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Game.saveGame(PATH_SAVE1, gameProgress1);
        Game.saveGame(PATH_SAVE2, gameProgress2);
        Game.saveGame(PATH_SAVE3, gameProgress3);
        Game.zipFiles(PATH_ARCHIV, PATH_SAVE1, PATH_SAVE2, PATH_SAVE3);
        //Задание 3
        Game.openZip(PATH_ARCHIV, FOLDER_FOR_SAVE );
        GameProgress gameProgress =  Game.openProgress(PATH_SAVE1);
